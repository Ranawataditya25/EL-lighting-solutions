...
const VideosSection = () => {
  // Fetch the most recent 3 videos
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            techniques for pain relief and rehabilitation.
          </p>
        </div>
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {displayedVideos.map((video) => (
                <div key={video.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                  <a 
